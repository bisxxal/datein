        ...
        <div className=" w-full scrollbar overflow-y-auto space-y-3 rounded-2xl h-[70vh] max-md:h-[76vh] ">
            ...
            <div key={dateKey}>
              <div className="text-center w-fit bg-[#ffffff5c] border border-white/80 mx-auto rounded-full px-3  backdrop-blur-[10px] my-4 text-sm text-gray-700 font-medium">
                ...
                {msgs.map((msg) => (
                  <div
                    key={msg.id}
                    className={`max-w-[80%] mt-3 shadow-xl w-fit py-1.5 overflow-hidden flex flex-col flex-wrap text-base font-normal px-5  
          ...
          <div className=" flex justify-between  glass overflow-hidden max-md:pr-[2px] rounded-3xl">
            {/* <input
              ...
              className="flex-1 px-4 py-2 w-[96%] text-white focus:outline-none"
           ...
           <textarea
                ...
                onChange={(e) => setNewMessage(e.target.value)}
                rows={1}
                className="flex-1 px-4 py-2 w-[96%] scrollbar resize-none overflow-auto text-white bg-transparent focus:outline-none leading-relaxed max-h-[200px]"
                placeholder="Type a message..."

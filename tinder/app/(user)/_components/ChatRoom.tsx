  ...
  return (
    ...
    <div className="flex- overflow-y-auto space-y-3 rounded-2xl h-[70vh] max-md:h-[76vh] ">
        { messages?.map((msg ) => (
          <div
            key={msg.id}
            className={`min-w-[30% w-fit py-1.5 text-base font-normal px-5  ${
              msg.senderId === currentUserId ? 'bg-blue-60 buttonbg text-white rounded-b-2xl rounded-l-2xl ml-auto '

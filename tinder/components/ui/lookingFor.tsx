...
const LookingFor = ({text}:{text:string}) => {
  return (
    ...
    >
        <div className=" h-[200px] w-[200px] absolute left-0 top-0 rounded-full !duration-700  center backdrop-blur-[10px] bg-pink-600/30 animate-ping  ">
        </div>
        <div className=" h-[140px] w-[140px] absolute  top-8  left-8 rounded-full !duration-700  center backdrop-blur-[10px] delay-[1.5s] bg-pink-600/50 animate-ping  ">
        </div>
